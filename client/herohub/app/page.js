...
export default function Home() {
  ...
  //   if(searchOpt.value === "Name"){
  //     useEffect(()=>{
  //       fetch(`http://localhost:${backPort}/search/+`,searchVal.value)
  //       .then(response=>response.json())
        
  //     })

  //   }
  //   else if(searchOpt.value==="Race"){

  //   }
  //   else if(searchOpt.value==="Publisher"){

  //   }

  //   else if(searchOpt.value==="Power"){
              ...
              <Grid templateColumns='repeat(2)' gap={10}>
                ...
                <input id="search" className="w-4/6 h-10 border border-gray-400 rounded-md focus:border-red-50 focus:ring focus:ring-red-300 focus:shadow-md transition duration-100 mx-5" variant='outline' placeholder='Search' />
                  <select id='searchOption' className="px-4 border border-gray-300 h-9 rounded-md w-3/6 max-w-screen-sm flex-1  text-red-800 bg-gray-200 px-2" variant="filled" placeholder="Search by">
                    ...
                    <button id='searchBtn'  className='align-right bg-red-700 text-white py-2 px-4 rounded-md text-sm'>search</button>
  ...
  {/*building a card to display superhero results */}
   {/*Vertical Cards for superheroes*/}
    ...
    <div className='w-3/4 relative justify-center mx-auto'>
          ...
          <Card className="border border-red-800 flex flex-col-relative min-w-0 w-30 bg-white px-4 py-2 rounded-md">
            <CardHeader className="mb-4">
              <Heading size='md' className="text-red-600 font-bold py-6 px-4">SuperHero Name</Heading>
            </CardHeader>
            <CardBody className="text-gray-700 px-4 py-5">
              <p>Publisher Name</p>
            </CardBody>
            <CardFooter className="align-right justify-right items-right">
              <button className='align-right bg-red-500 hover:bg-red-800 text-white py-2 px-3 rounded-md text-sm'>View Information</button>
            </CardFooter>
          </Card>
          <Card className="border border-red-800 flex flex-col-relative min-w-0 w-30 bg-white px-4 py-2 rounded-md">
            <CardHeader className="mb-4">
          ...
          <Card className="border border-red-800 flex flex-col-relative min-w-0 w-30 bg-white px-4 py-2 rounded-md">
            <CardHeader className="mb-4">
              <Heading size='md' className="text-red-800 font-bold py-6 px-4">SuperHero Name</Heading>
            </CardHeader>
            <CardBody className="text-gray-700 px-4 py-5">
              <p>Publisher Name</p>
            </CardBody>
            <CardFooter className="align-right justify-right items-right">
              <button className='align-right bg-red-500 text-white py-2 px-3 rounded-md text-sm hover:bg-red-800'>View Information</button>
            </CardFooter>
          </Card>
